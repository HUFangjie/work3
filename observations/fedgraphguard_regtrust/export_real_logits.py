        ...
        for beta in args.betas:
            ...
            for mode in args.model_modes:
                ...
                for cid in range(args.num_clients):
                    ...
                    c_subset = Subset(ds, global_parts[cid])
                    train_bs = min(64, max(2, len(c_subset)))
                    c_loader = DataLoader(c_subset, batch_size=train_bs, shuffle=True, num_workers=2, drop_last=True)
